...
<Callout title="Project Documentation" type="info">
  This section contains your product documentation. Use the [MVP Documentation Framework](/docs/product-docs) to systematically document your product idea, architecture, costs, database design, and user flows.
</Callout>
